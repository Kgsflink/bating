...
(function() {
    ...
    const handleFetch = (response, args) => {
        if (interceptEnabled && (response.url.includes("tirangaapi.com/api/webapi/GetTRXGameIssue") || response.url.includes("tirangaapi.com/api/webapi/GetTRXNoaverageEmerdList"))) {
    ...
    XMLHttpRequest.prototype.send = function(body) {
        this.addEventListener('load', function() {
            if (interceptEnabled && (this._url.includes("tirangaapi.com/api/webapi/GetTRXGameIssue") || this._url.includes("tirangaapi.com/api/webapi/GetTRXNoaverageEmerdList"))) {
